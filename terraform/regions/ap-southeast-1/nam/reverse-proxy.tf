...
#     # Pull image
#     docker pull ${local.reverse_proxy_image_arn}

#     # Create systemd service for the container
#     cat <<SERVICE > /etc/systemd/system/myproxy.service
#     [Unit]
#     Description=MyProxy Container
#     After=docker.service
#     Requires=docker.service

#     [Service]
#     Restart=always
#     ExecStart=/usr/bin/docker run --rm --name myproxy -p 8888:8888 -e PORT=8888 -e BACKENDS=http://172.29.2.10:8000 ${local.reverse_proxy_image_arn}
